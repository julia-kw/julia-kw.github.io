...
**Class Hours and Room** Tuesdays/Thursdays 11:00–12:15, Bldg. 4 Room 105
...
and exponential growth, mathematical modeling, and geometry

**Prerequisite** MAT035 (Algebra for Non-STEM) or MAT045 (Intermediate Algebra for STEM) or satisfactory basic
skills assessment score

**Departmental Syllabus** (with formal learning outcomes) [https://capecod.b-cdn.net/app/uploads/2026/04/MAT130.pdf](https://capecod.b-cdn.net/app/uploads/2026/04/MAT130.pdf)

Informal Learning Outcomes
========

This course is a survey of topics in mathematics you can use to improve your reasoning. Upon the successful completion of this course you will be able to use logical concepts to analyze the validity of deductive reasoning, interpret data using statistics, assess the correctness of statistical inference, and think critically about the use of prediction models.
...
* Unit 1 (9/8–10/8): Logic
  ...
  * Week 1: Intro, Arguments

  * Week 2: Language, Truth tables

  * Week 3: Entailment, Semantic notions

  * Week 4: Quantifiers, Models

  * Week 5: Review, Exam

* Unit 2 (10/13–11/12): Statistics

  * Week 6: Intro, Visualizing data

  * Week 7: Averages, Range and quartiles

  * Week 8: Box and whisker plots, Standard deviation

  * Week 9: Normal distibutions, hypothesis testing

  * Week 10: Review, Exam

* Unit 3 (11/17–12/10): Modeling

  * Week 11: Intro, Functions

  * Week 12: Linear models, Exponential functions

  * Week 13: Exponential models, Logistic models
