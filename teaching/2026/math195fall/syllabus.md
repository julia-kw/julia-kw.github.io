---
layout: page
title: "Math 195 Syllabus (Fall 2026)"
permalink: /teaching/2026/math195fall/syllabus/
parentlink: /teaching/2026/math195fall/
---
...
**Website** [http://juliakw.net/teaching/2026/math195fall/]({{ site.baseurl }}/teaching/2026/math195fall/)
...
**Course Description** Targeting students in Mathematics, Engineering, and Physical Sciences, this course provides the
foundation necessary for a rigorous study of calculus. It covers non-linear inequalities, functions, and graphs. The
primary focus is on  polynomial, rational, exponential, logarithmic, and trigonometric functions. Applications are also
discussed extensively. Additional topics may include analytic geometry with an emphasis on the conic sections, Gibbs
notation vector algebra, polar coordinates, sequences, series, and mathematical induction.

**Prerequisite** A grade of C- or higher in MAT175 (College Algebra) or satisfactory basic skills assessment score

**Departmental Syllabus** (with formal learning outcomes) [https://www.capecod.edu/media/capecodedu/content-assets/documents/syllabi/mat195.pdf](https://www.capecod.edu/media/capecodedu/content-assets/documents/syllabi/mat195.pdf)
...
Homework will be assigned weekly, due in-class the Tuesday of the following week. 
...
Homework grades are based on completion and my selection of one problem.

* Rubric for completion

    * 50/50: you did all problems.
	
    * 30/50: you did most problems.
	
    * 0/50: you did only a few problems.
	
* Rubric for individual problem

    * 50/50: you gave a full correct solution.

    * 40/50: you made a minor error.
	
    * 20/50: you were on the right track but were unable to finish or made significant errors.
	
    * 0/50: you didn't make meaningful progress toward a correct solution.
...
I will not accept late work. Instead, I will drop your lowest homework score from consideration for your final grade.
...
Each class period, not including exam days and a few other exceptions, will begin with a short two question quiz about the material we covered the previous class. After the quiz we grade them together according to the following rubric for the problems.

* 5/5: You did the problem correctly.

* 4/5: You got all the way through to a complete solution, but you made a minor mistake along the way.

* 2/5: You started on the problem but were unable to finish it. 

* 0/5: You didn't make meaningful progress toward the problem. Or you didn't show any work and got a wrong final answer.
...
There will be two midterm exams. Additionally, the course will conclude with a comprehensive final exam.  These are in-class, written, individual exams.
...
* Midterm 2: Thursday, November 19
...
We will use *Precalculus* 2e, Openstax ([Available freely online](https://openstax.org/details/books/precalculus-2e)) for our textbook. It will be a reference for you as well as a source of homework problems. While the book is freely available online in multiple formats, if you prefer a paper copy you may purchase one.


Attendance and Class Participation Guidelines
==========

You are expected to attend class sessions, and this is factored into your grade via the quizzes. Like most math classes the material in this class builds upon itself. If you skip class and fall behind it is difficult to get back on track. If you miss a class, it is your responsibility to ensure you make up the missed lesson. The schedule on the course website gives the textbook sections we will cover each week. If you know in advance you will have to miss a class, please email me.

Class time will be spent on a combination of quizzes, lecture, and group work/discussion. 
...
Office hours, both in-person and virtual, are held multiple times in the week, to give you an opportunity to ask questions and receive help in-person outside of class time. If you prefer to meet at a different time, please contact me to arrange that.
...
Anyone who feels they may need accommodation based on the impact of a disability should contact the [O'Neill Center for Student Access and Support](https://capecod.edu/oneillcenter/) (774-330-4453; `oneillcenter@capecod.edu`)
...
* Submitting work entirely generated by an LLM.
...
* Unit 1 (9/8–10/15): Elementary Functions

    * Week 1: Intro, Quadratic functions (3.2)
	
    * Week 2: Power functions, reciprocals of power functions (3.3, 3.7)
	
    * Week 3: Inverses, radicals (3.8)
	
    * Week 4: Exponential and logarithmic functions (4.1–4.4)
	
    * Week 5: More exponential and logarithmic functions (4.5, 4.6)

    * Week 6: Review and midterm 1

* Unit 2 (10/20–11/19): Trigonomentry

    * Week 7: Angles and circles (5.1–5.3)

    * Week 8: Triangles (5.4, 8.1, 8.2)

    * Week 9: Waves and graphs (6.1–6.3)

    * Week 10: Identities and equations (7.1, 7.2, 7.5)

    * Week 11: Review and midterm 2

* Unit 3 (11/24–12/10): A preview of calculus

    * Week 12: Polynomials (3.4)

    * Week 13: Rational functions (3.7)
	
    * Week 14: Series, review for final
