...
* **Week 7 (Due Friday 3/14)** Section 7.5 #2, 3, 5, 9, 22; Section 7.6 #1, 2, 9, 10

    Writing: Find the surface area generated by rotating the ellipse $x + 4y^2 = 1$ around the $x$-axis. (Extra Credit) Do the same thing for the generic ellipse $\frac{x^2}{a^2} + \frac{y^2}{b^2} = 1$.
